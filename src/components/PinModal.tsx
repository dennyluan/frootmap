...
export const PinModal = (modalProps: {isShown: boolean, hide: any, createPin: any}) => {
  const [fruit, setFruit] = useState<string>("")
  const [error, setError] = useState<string>("")

  const FRUITS = [
    "Mango", "Pineapple", "Lemon", "Lime", "Orange", "Coconut",
    "Pomegranate", "Pomelo", "Eggplant"
  ]
